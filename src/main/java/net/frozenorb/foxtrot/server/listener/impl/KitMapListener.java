...
public class KitMapListener implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        ...
        if (victim.getKiller() != null && !victim.getUniqueId().equals(victim.getKiller().getUniqueId()) && !Players.isNaked(victim)) {
            ...
            EconomyHandler.deposit(victim.getKiller().getUniqueId(), 100 + getAdditional(victim.getKiller()));
            ...
            Bukkit.getScheduler().runTask(HCF.getInstance(), () -> {
                int kills = HCF.getInstance().getMapHandler().getStatsHandler().getStats(victim.getKiller()).getKills();
                if (kills % 10 == 0) {
