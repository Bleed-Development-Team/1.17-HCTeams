...
import net.frozenorb.foxtrot.extras.blockshop.category.BuyMenu;
import net.frozenorb.foxtrot.extras.blockshop.impl.*;
import net.frozenorb.foxtrot.extras.blockshop.category.SellMenu;
...
public class BlockShop extends Menu {
    ...
    public void tick() {
        ...
        this.buttons[23] = new MainButton("&6&lClay", Material.CLAY).setClickAction(this::not);
    ...
    private void not(InventoryClickEvent event){
        event.setCancelled(true);
        getPlayer().sendMessage(CC.translate("&cThis feature is not available yet."));
    }
