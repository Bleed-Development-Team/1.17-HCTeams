package net.frozenorb.foxtrot.extras.blockshop.category;
...
import net.frozenorb.foxtrot.extras.blockshop.button.SellButton;
    ...
    public void sell(Material material, InventoryClickEvent event, int amount) {
        ...
        if (player.getInventory().contains(material)){
            ...
            if (converted.getAmount() >= 16){
                ...
                player.sendMessage(CC.translate("&aSell complete! Your new balance is: $" + FrozenEconomyHandler.getBalance(player.getUniqueId())));
            } else {
