...
import net.frozenorb.foxtrot.util.serialization.ItemStackSerializer;
...
public class CitadelHandler {
    ...
    public void loadCitadelInfo() {
        try {
            if (!citadelInfo.exists() && citadelInfo.createNewFile()) {
                ...
                FileUtils.write(citadelInfo, HCF.GSON.toJson(new JsonParser().parse(dbo.toString())));
            }
    ...
    public boolean respawnCitadelChest(Location location) {
        ...
        if (blockState instanceof Chest) {
            ...
            chest.getBlockInventory().addItem(citadelLoot.get(HCF.RANDOM.nextInt(citadelLoot.size())));
            return (true);
        } else {
