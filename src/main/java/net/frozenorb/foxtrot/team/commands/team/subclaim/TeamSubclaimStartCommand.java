...
public class TeamSubclaimStartCommand {
    ...
    @Command(value ={ "team subclaim start", "t subclaim start", "f subclaim start", "faction subclaim start", "fac subclaim start", "team sub start", "t sub start", "f sub start", "faction sub start", "fac sub start" })
    public static void teamSubclaimStart(@Sender Player sender) {
