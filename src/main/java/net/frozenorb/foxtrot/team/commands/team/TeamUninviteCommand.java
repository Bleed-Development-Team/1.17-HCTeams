...
public class TeamUninviteCommand {
    ...
    @Command(value={ "team uninvite", "t uninvite", "f uninvite", "faction uninvite", "fac uninvite", "team revoke", "t revoke", "f revoke", "faction revoke", "fac revoke" })
    public static void teamUninvite(@Sender final Player sender, @Name("all | player") final String allPlayer) {
