...
public class TeamSubclaimListCommand {
    ...
    @Command(value ={ "team subclaim list", "t subclaim list", "f subclaim list", "faction subclaim list", "fac subclaim list", "team sub list", "t sub list", "f sub list", "faction sub list", "fac sub list" })
    public static void teamSubclaimList(@Sender Player sender) {
