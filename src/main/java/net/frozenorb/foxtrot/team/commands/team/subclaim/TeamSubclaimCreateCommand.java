...
public class TeamSubclaimCreateCommand {
    ...
    @Command(value ={ "team subclaim create", "t subclaim create", "f subclaim create", "faction subclaim create", "fac subclaim create", "team sub create", "t sub create", "f sub create", "faction sub create", "fac sub create" })
    public static void teamSubclaimCreate(@Sender Player sender, @Name("subclaim") String subclaim) {
