...
public class TeamForceLeaveCommand {
    ...
    @Command(value={  "team forceleave", "t forceleave", "f forceleave", "faction forceleave", "fac forceleave", "t fl", "team fl" })
    public static void forceLeave(@Sender Player sender) {
