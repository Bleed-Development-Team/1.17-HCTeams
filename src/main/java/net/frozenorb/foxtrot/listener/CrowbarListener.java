...
public class CrowbarListener implements Listener {
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (event.getClickedBlock().getType() == Material.END_PORTAL_FRAME) {
            ...
            event.getClickedBlock().getWorld().playEffect(event.getClickedBlock().getLocation(), Effect.STEP_SOUND, event.getClickedBlock().getBlockData());
            ...
            for (int x = -3; x < 3; x++) {
                for (int z = -3; z < 3; z++) {
                    ...
                    if (block.getType() == Material.END_PORTAL) {
                        ...
                        block.getWorld().playEffect(block.getLocation(), Effect.STEP_SOUND, Material.END_PORTAL.getData());
                    }
                }
            }
            ...
            if (portals == 0) {
                event.getPlayer().getItemInUse().setType(Material.AIR);
            ...
            event.getClickedBlock().getLocation().getWorld().playEffect(event.getClickedBlock().getLocation(), Effect.STEP_SOUND, event.getClickedBlock().getBlockData());
            event.getClickedBlock().setType(Material.AIR);
            event.getClickedBlock().getState().update();
