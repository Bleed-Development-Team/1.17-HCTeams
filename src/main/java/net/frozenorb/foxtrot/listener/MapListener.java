...
public class MapListener implements Listener {
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        ...
        if (event.getEntity().getKiller() != null) {
            ...
            if (player.getItemInUse() != null && player.getItemInUse().containsEnchantment(Enchantment.LOOT_BONUS_MOBS)) {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        if (!Foxtrot.getInstance().getMapHandler().isFastSmeltEnabled() || event.getPlayer().getItemInUse() == null || !event.getPlayer().getItemInUse().getType().name().contains("PICKAXE") || event.getPlayer().getItemInUse().containsEnchantment(Enchantment.SILK_TOUCH)) {
            return;
        }
    ...
    public void onProjectileLaunch(ProjectileLaunchEvent event) {
        ...
        ItemStack inHand = ((Player) shooter).getItemInUse();
