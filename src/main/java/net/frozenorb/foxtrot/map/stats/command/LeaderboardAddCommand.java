...
public class LeaderboardAddCommand {
    ...
    @Command(value = {"leaderboard add"})
    @Permission(value = "op")
    public static void leaderboardAdd(@Sender Player sender, @Name("objective") String objectiveName, @Name("place") int place) {
    ...
    @Command(value = {"clearleaderboards"})
    @Permission(value = "op")
