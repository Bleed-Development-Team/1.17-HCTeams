...
public class MapHandler {
    ...
    public void load() {
        ...
        ShapedRecipe horseArmorRecipe = new ShapedRecipe(new ItemStack(Material.DIAMOND_HORSE_ARMOR));

        nametagRecipe.shape(" I ",
                                                     " P ",
                                                     " S ");
        nametagRecipe.setIngredient('I', Material.INK_SAC);
        ...
        saddleRecipe.setIngredient('B', Material.LEAD);
