...
public final class EntityUtils {
    ...
    public static EntityType parse(String input) {
        ...
        int i;
        byte b;
        for (arrayOfEntityType = EntityType.values(), i = arrayOfEntityType.length, b = 0; b < i; ) {
            EntityType type = arrayOfEntityType[b];
    ...
    static {
        ...
        displayNames.put(EntityType.PIGLIN, "Zombie Pigman");
